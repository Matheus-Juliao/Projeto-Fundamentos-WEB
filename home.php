               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="screens/training-plans/training-plans.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="screens/training-plans/training-plans.php" class="small-box-footer">Clique aqui<i class="fa-solid fa-person"></i></a>
                            </div>
                        </div>
